/*
  ...
  - Added the required column `emailIsValid` to the `User` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "emailIsValid" BOOLEAN NOT NULL,
